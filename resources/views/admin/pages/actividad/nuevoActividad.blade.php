        ...
        <div class="col-12 col-md-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.create')}}" id="equipo" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                        @csrf
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="nombres">Nombre*</label>
                                    <input class="form-control" id="nombres" name="nombre" type="text" placeholder="Ingresa su nombre del equipo" autocomplete="off" pattern="[A-Z a-záéíóúÁÉÍÓÚñÑ]{3,50}" title="Solo letras" data-sb-validations="required" required />
                                    <div class="valid-feedback">El nombre es Valido</div>
                                    <div class="invalid-feedback">Requerimos el Nombre del equipo (Solo letras).</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="apellidos">Apellidos*</label>
                                    <input class="form-control py-4" id="apellidos" name="apellidos" type="text" placeholder="Ingresa su apellido completo del equipo" autocomplete="off" pattern="[A-Z a-záéíóúÁÉÍÓÚñÑ]{3,50}" title="Solo letras" data-sb-validations="required" required />
                                    <div class="valid-feedback">El apellido es Valido</div>
                                    <div class="invalid-feedback">Requerimos el Apellido del equipo (Solo letras).</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="invalid-feedback">Selecciona el lugar de salida del equipo.</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="invalid-feedback">Escribe la direccion del equipo a recoger.</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="invalid-feedback">Selecciona cómo se entero el equipo de nosotros</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="invalid-feedback">Selecciona la ciudad del equipo</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="valid-feedback">Datos validos</div>
                                    <div class="invalid-feedback">Selecciona la estado del equipo</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="valid-feedback">Datos validos</div>
                                    <div class="invalid-feedback">Selecciona la pais del equipo</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                            </div>
                        ...
                        <div class="col-md-12">
                                <label for="descripcion">Descripción breve del equipo (opcional)</label>
                                <div class="mb-3">
                                    <div class="form-group">
