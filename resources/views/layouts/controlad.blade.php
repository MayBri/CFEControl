                ...
                <div class="navbar-brand">
                    ...
                    <a href="/">
                        ...
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="{{ asset('img/logo2.png') }}"  style="width:150px" alt="homepage" class="dark-logo" />
                            <!-- Light Logo text -->
                            <img src="{{ asset('img/logo2.png') }}"  style="width:130px" class="light-logo" alt="homepage" />
                        </span>
                    </a>
                </div>
                <!-- ============================================================== -->
                ...
                <ul class="navbar-nav float-right">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu animated flipInY">
                            ...
                            <div class="dropdown-divider"></div>
                            <div class="pl-4 p-3">
                                <a class="btn btn-sm btn-danger" href="{{ route('logout') }}" data-toggle="modal" data-target="#logoutModal">
    ...
    <aside class="left-sidebar" data-sidebarbg="skin6">
        ...
        <div class="scroll-sidebar" data-sidebarbg="skin6">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    <li class="sidebar-item"> <a class="sidebar-link sidebar-link active" href="{{url('admin')}}"
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{url('calendario')}}" aria-expanded="false">
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{route('admin.equipo.lista')}}"  aria-expanded="false">
                        <i data-feather="list" class="feather-icon"></i>
                        <span class="hide-menu">Lista equipos</span></a>
                    </li>
                    <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{route('admin.nuevo')}}"  aria-expanded="false">
