        ...
        <nav class="navbar main-nav fixed-top navbar-expand-lg large">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <!-- Link de menu -->
                            <li class="nav-item">
                              <a class="nav-link scrollTo" href="{{ url('/') }}">Inicio</a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link scrollTo" href="{{ route('admin') }}">Contacto</a>
                            </li>
                            <li class="nav-item">
                             <!--   <a class="nav-link btn btn-primary  text-white" href="{{ route('admin') }}">{{ __('Inicio de Sesion') }}</a> -->
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('admin') }}">{{ __('Mi sesion') }}</a>
                                    <hr>
