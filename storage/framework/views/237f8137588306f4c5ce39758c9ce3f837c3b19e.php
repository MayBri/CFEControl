        ...
        <nav class="navbar main-nav fixed-top navbar-expand-lg large">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <!-- Link de menu -->
                            <li class="nav-item">
                              <a class="nav-link scrollTo" href="<?php echo e(url('/')); ?>">Inicio</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <?php else: ?>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="<?php echo e(route('admin')); ?>"><?php echo e(__('Mi sesion')); ?></a>
                                    <hr>
                                    ...
                                    <form id="admin-form" action="<?php echo e(route('admin')); ?>" method="POST" class="d-none">
                                        <?php echo csrf_field(); ?>
                                    </form>
                                </div>
                            </li>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4 text-lg-right">
          ...
          <p>Redes Sociales | Sitios Oficiales</p>
...
<?php /**PATH C:\xampp\htdocs\CFEControl\resources\views/layouts/app.blade.php ENDPATH**/ ?>