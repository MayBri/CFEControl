...
<div class="page-breadcrumb">
            <div class="row">
                <div class="col-7 align-self-center">
                    <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Lista de tours Clientes</h3>
                    <div class="d-flex align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0 p-0">
                                <li class="breadcrumb-item"><a href="index.html">Administrador/ Tours / Lista clientes</a>
                                </li>
                            </ol>
                        </nav>
                    </div>
...
<div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Tabla de tours clientes</h4>
...
<?php echo $__env->make('layouts.libviajes', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LibViajes\resources\views/admin/pages/tours/cliente.blade.php ENDPATH**/ ?>