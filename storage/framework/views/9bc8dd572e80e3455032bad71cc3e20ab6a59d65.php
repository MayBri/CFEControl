        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <img src="<?php echo e(url('img/aida2.png')); ?>" alt="">
                </div>
                
                <h1 class="mt-2 text-gray-600 dark:text-gray-400">Sistema para Agencias de Viajes, LibViajes</h1>
                        ...
                        <div class="p-6">
                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Mollitia, sapiente.</p>
...
<?php /**PATH C:\xampp\htdocs\LibViajes\resources\views/welcome.blade.php ENDPATH**/ ?>